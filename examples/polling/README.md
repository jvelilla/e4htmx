...
.
├── src/
│ ├── htmx_polling.e         # Main application service
│ └── htmx_polling_execution.e # Request execution handling
├── www/
│ ├── index.html          # Main HTML file
│ └── styles.css          # Application styles
└── htmx_polling.ecf         # Eiffel configuration file
```
## Overview
...
Our demo currently demonstrates HTMX's polling feature:

1. **Page polling**: Using `hx-boost` attribute to enhance regular links:
   ```html
