...
feature {NONE} -- Initialization
	...
	make (a_condition: READABLE_STRING_GENERAL; a_true_branch: ARRAYED_LIST [GLM_TEMPLATE_NODE]; a_false_branch: detachable ARRAYED_LIST [GLM_TEMPLATE_NODE])
...
feature -- Access
	...
	condition_expr: GLM_EXPRESSION_NODE
			-- Compiled condition expression

	true_branch: ARRAYED_LIST [GLM_TEMPLATE_NODE]
			-- AST nodes for the true branch

	false_branch: detachable ARRAYED_LIST [GLM_TEMPLATE_NODE]
			-- AST nodes for the false branch (else block)

feature -- Element Change

	set_false_branch (a_false_branch: ARRAYED_LIST [GLM_TEMPLATE_NODE])
